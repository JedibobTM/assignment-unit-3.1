...
let favoriteFoods = ['steak', 'french onion soup', 'hamburgers']
console.log(favoriteFoods + ' are some of my favorite foods')
...
console.log('The third and final animal is: ' + lastAnimal);
...
console.log('Added an entree: ' + entree);
...
console.log(lastColor + ' is the removed color');
console.log(colors + ' are the correct colors');
...
console.log('NOW the correct colors are ' + colors);
